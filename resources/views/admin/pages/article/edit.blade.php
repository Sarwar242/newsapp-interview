...
<div class="content-wrapper">
    ...
    <div class="card shadow-sm">
        <div class="card-body m-3">
            <form method="post" action="{{ route('panel.news.articles.update', $article->id) }}"
                ...
                <div class="row">
                    <div class="col-md-10">
                        <div class="form-group row @error('title') error @enderror">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="title"
                                    value="{{ old('title', $article->title) }}" placeholder="{{ __('Title') }}"
                                    required>
                                @error('title')
                        ...
                        <div class="form-group row @error('thumb') error @enderror">
                            ...
                            <div class="col-sm-9">
                                <div class="file-upload-section">
                                    <input name="thumb" type="file" class="form-control hidden_file"
                                    ...
                                    <div class="display-input-image @if($article->thumb == null) d-none @endif">
                                        <img src="{{ $article->getThumb() }}" alt="Preview Image" />
                        ...
                        <div class="form-group row @error('picture') error @enderror">
                            ...
                            <div class="col-sm-9">
                                <div class="file-upload-section">
                                    <input name="picture" type="file" class="form-control hidden_file"
                                        allowed="png,gif,jpeg,jpg">
                                    <div class="input-group col-xs-12">
                                        <input type="text"
                                    ...
                                    <div class="display-input-image @if($article->picture == null) d-none @endif">
                                        <img src="{{ $article->getImage() }}" alt="Preview Image" />
                                        <button type="button" class="btn btn-sm btn-outline-danger file-upload-remove"
                                            title="Remove">x</button>
                                    </div>
